...
export const serverInstructions = [
  ...
  "- Readings arrive about once a second. After an action, compare the reading number to confirm you are not looking at the same reading twice, or call wait_for_condition to wait for a scene or member value instead of guessing how long to wait.",
